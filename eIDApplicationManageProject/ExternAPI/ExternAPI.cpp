...
BOOL EXTERNAPI_API UKeyCheckPIN(HANDLE hUKey, int nLanguage)
{
...
BOOL EXTERNAPI_API UKeyChangePIN(HANDLE hUKey, int nLanguage)
{
/*
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//读取卡内容器数据
BOOL EXTERNAPI_API UKeyGetContainerData(HANDLE hUKey, unsigned char *Data, short *DataLength, short *ContainerCount)
{
